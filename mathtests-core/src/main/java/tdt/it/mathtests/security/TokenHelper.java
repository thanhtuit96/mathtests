package tdt.it.mathtests.security;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;
import tdt.it.mathtests.common.TimeProvider;
...
public class TokenHelper {
    ...
    public String generateToken(String username,String authority, Device device) {
